...
@ContextConfiguration({"classpath:test-e2e-config.xml",
		"classpath:claimcheck-in-integration-config.xml",
		"classpath:claimcheck-out-integration-config.xml",
		"classpath:subscriber-integration-config.xml"})
public class End2EndFlowTest {
	static {
		System.setProperty("spring.profiles.active", "dev");
	}
	private static Logger logger = Logger
			.getLogger(End2EndFlowTest.class);
